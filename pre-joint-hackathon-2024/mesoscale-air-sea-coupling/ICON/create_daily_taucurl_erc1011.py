...
#    Ek_Classic=curltau/(rho0*fCo)
    curloftau=curltau/(rho0*fCo)*(rho0*fCo)
...
#    writenc1d_r2b9O(wektfile,nctime,14886338,Ek_Classic,'Wekclassic','Ekman pumping (Classic)','Ekman_Classic','m/s')    
    taucurlfile=outdir+'taucurl/dm/'+expid+'_taucurl_dm_'+fdate+'.nc'
    print('Write to '+taucurlfile)
    writenc1d_r2b9O(taucurlfile,nctime,14886338,curloftau,'taucurl','Wind stress curl','tau_curl','N/m2')    
